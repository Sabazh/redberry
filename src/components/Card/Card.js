...
const Card = () => {
  return (
    <div className='flex flex-col items-start gap-2-4 w-40-8 overflow-hidden'>
        ...
        <div className='flex flex-col gap-1-6 items-start'>
            ...
            <p className='font-fB text-2-0'>EOMM-ის მრჩეველთა საბჭოს ნინო ეგაძე შეუერთდა</p>
            <div className='flex gap-1-6'>
                <CategoriesButton backgroundColor={blue} textColor={white} disabled>მარკეტი</CategoriesButton>
            </div>
            <p className='font-fR text-1-6 text-dark01 h-5-6'>6 თვის შემდეგ ყველის ბრმა დეგუსტაციის დროც დადგა. მაქსიმალური სიზუსტისთვის, ეს პროცესი...</p>
