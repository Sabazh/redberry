...
const Login = () => {
    const { loginHandler, isLoggedIn, isLoggedInHandler } = useContext(AppContext);
            ...
            {isLoggedIn ? (
                <div className='flex flex-col gap-4-8'>
                    <div className='flex flex-col items-center justify-center gap-1-6 px-7-4'>
                        ...
                        <p className='font-fB text-2-0 text-dark'>წარმატებული ავტორიზაცია</p>
                    </div>
                    <Button color="blue" onClick={() => loginHandler(false)}>კარგი</Button>
                </div>
            ) : (
                <div className='flex flex-col gap-2-4'>
                    <h1 className='flex items-center justify-center text-2-4 font-fB text-dark'>შესვლა</h1>
                        ...
                        <div className='flex flex-col gap-0-8'>
                            ...
                            {error && 
                                <div className='flex gap-0-8'>
                                    <img src='/svg/red-!.svg'/>
                                    <span className='font-fR text-1-2 text-red'>ელ-ფოსტა არ მოიძებნა</span>
                                </div>
                            }   
                        </div>
